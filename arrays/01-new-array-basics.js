...
const array2 = new Array("Monday", "Tuesday", "Wednesday", "Friday", "Saturday", "Sunday");
...
array2.push("Thusday");
console.log("I added 1 element to the array. Array has now " + array2.length + " elements.")
 ...
 */
console.log("-----Task E-----")
const people = ["Jan Nowak","Kazimierz Zyga","Stefan Koc","Ewa Mocek","Mariusz Abramski"];
Array.isArray(people) ? console.log("People is an array") : console.log("People is not an array");